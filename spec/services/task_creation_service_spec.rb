...
RSpec.describe TaskCreation do
  ...
  describe '.call' do
    context 'with valid parameters' do
      it 'creates a task successfully' do
        result = TaskCreation.call(user: user, params: ActionController::Parameters.new(params))
      ...
      it 'sets default status to pending when not provided' do
        ...
        result = TaskCreation.call(user: user, params: ActionController::Parameters.new(params_without_status))
      ...
      it 'allows setting custom status' do
        ...
        result = TaskCreation.call(user: user, params: ActionController::Parameters.new(params_with_status))
      ...
      it 'validates task parameters' do
        ...
        result = TaskCreation.call(user: user, params: ActionController::Parameters.new(invalid_params))
    ...
    context 'with assignee' do
      ...
      it 'assigns task to assignee' do
        result = TaskCreation.call(user: user, params: ActionController::Parameters.new(params_with_assignee))
      ...
      it 'does not send notification when no assignee' do
        expect {
          TaskCreation.call(user: user, params: ActionController::Parameters.new(task: params))
    ...
    context 'with nested params structure' do
      it 'handles nested task params' do
        ...
        result = TaskCreation.call(user: user, params: ActionController::Parameters.new(nested_params))
    ...
    context 'error handling' do
      it 'handles invalid user gracefully' do
        result = TaskCreation.call(user: nil, params: ActionController::Parameters.new(params))
